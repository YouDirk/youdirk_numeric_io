...
RUN_SERVERPROD_DIR = $(RUN_DIR)/productive_server
...
LANG_FILES_GEN_ALL = $(LANG_FILES_GEN_EN) $(LANG_FILES_GEN_DE)
...
WEBSITE_TESTCASES_DOC_REL = blob/master/TEST_CASES.md
